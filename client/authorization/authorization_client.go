...
type ClientService interface {
	...
	RegisterComputer(params *RegisterComputerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegisterComputerOK, error)
...
/*
  LoginUser logins with user credentials
*/
...
/*
  RegisterComputer creates a computer and get the computer api key
*/
func (a *Client) RegisterComputer(params *RegisterComputerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegisterComputerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewRegisterComputerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "registerComputer",
		Method:             "POST",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &RegisterComputerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*RegisterComputerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for registerComputer: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
