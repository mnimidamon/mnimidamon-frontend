...
// WithFilter adds the filter to the get users params
func (o *GetUsersParams) WithFilter(filter *string) *GetUsersParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the get users params
func (o *GetUsersParams) SetFilter(filter *string) {
	o.Filter = filter
}
